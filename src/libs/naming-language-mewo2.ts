// FROM : https://github.com/mewo2/naming-language
...
export function getName(lang, key) {
    key = key || '';
...
export function makeRandomLanguage() {
    ...
    lang.phonemes.C = shuffled(choose(consets, 2).C) as any;
    lang.phonemes.V = shuffled(choose(vowsets, 2).V) as any;
    lang.phonemes.L = shuffled(choose(lsets, 2).L) as any;
    lang.phonemes.S = shuffled(choose(ssets, 2).S) as any;
    lang.phonemes.F = shuffled(choose(fsets, 2).F) as any;
