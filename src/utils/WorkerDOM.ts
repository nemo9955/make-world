...
//     timeStamp: number;
//     type: string;
//     composedPath(): EventTarget[] { throw new Error("Method not implemented."); }
// var stopAct(type: string, bubbles?: boolean, cancelable?: boolean): void { throw new Error("Method not implemented."); }
//     initEvent = stopAct
//     preventDefault(): void { throw new Error("Method not implemented."); }
//     stopImmediatePropagation(): void { throw new Error("Method not implemented."); }
//     stopPropagation(): void { throw new Error("Method not implemented."); }
//     AT_TARGET: number;
...
export class WorkerDOM implements HTMLElement {
    ...
    dispatchEvent(event: any): boolean {
        ...
        this.actions.callAction(event["type"], event)
        return true;
    }
